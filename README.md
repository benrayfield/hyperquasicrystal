...
While I speculate and hope that this might lead to something bigger, the main usecase of it as of now (2022-1) is that if wikibinator202 is attacked that it may retreat to a stronger position of being wrapped inside hyperquasicrystal, as may any other data and turing-complete patterns, that whoever wants to may so wrap, and share among those who choose to receive it, and not among those who dont want to receive, with ultra high protection of data integrity, redundancy, mirroring, and turing-complete-challenge-response.
